...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('polls', '0055_rename_mymodel_framework'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cliente', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='temp_actions', to='polls.cliente')),
            ],
        ),
    ]
