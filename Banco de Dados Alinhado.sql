...
CREATE TABLE IF NOT EXISTS `db_mysite`.`polls_framework` (
  ...
  PRIMARY KEY (`id`))
ENGINE = InnoDB
AUTO_INCREMENT = 17509
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;


-- -----------------------------------------------------
-- Table `db_mysite`.`polls_log`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_mysite`.`polls_log` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `data_time` DATETIME(6) NOT NULL,
  `descricao` LONGTEXT NOT NULL,
  `cliente_id` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `polls_log_cliente_id_efd21e5d_fk_polls_cliente_id` (`cliente_id` ASC) VISIBLE)
ENGINE = InnoDB
AUTO_INCREMENT = 136
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
